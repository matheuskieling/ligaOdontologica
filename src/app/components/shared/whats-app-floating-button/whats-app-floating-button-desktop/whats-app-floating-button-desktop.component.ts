...
@Component({
  selector: 'app-whats-app-floating-button-desktop',
  templateUrl: './whats-app-floating-button-desktop.component.html',
  styleUrls: ['./whats-app-floating-button-desktop.component.scss']
})
export class WhatsAppFloatingButtonDesktopComponent {
