...
@Component({
  selector: 'app-especialidades-page-desktop',
  templateUrl: './especialidades-page-desktop.component.html',
  styleUrls: ['./especialidades-page-desktop.component.scss']
})
export class EspecialidadesPageDesktopComponent {
  isWhatsOpened = false;
